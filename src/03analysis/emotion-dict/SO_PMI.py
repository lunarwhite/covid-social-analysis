...
class SoPmi:
    def __init__(self):
        self.train_path = 'res\\input\\SOPMI\\train.txt'
        self.candipos_path = 'res\\input\\SOPMI\\pos.txt'
        self.candineg_path = 'res\\input\\SOPMI\\neg.txt'
        self.sentiment_path = 'res\\input\\SOPMI\\sentiment_words.txt'
