...
chart1.render('res\\output\\clustering\\image1\\武汉封城-聚类分析饼图.html')
chart2.render('res\\output\\clustering\\image1\\人传人-聚类分析饼图.html')
chart3.render('res\\output\\clustering\\image1\\对口支援-聚类分析饼图.html')
chart4.render('res\\output\\clustering\\image1\\复工复产-聚类分析饼图.html')
